...
func NewLoadBalanceReverseProxy(c *middleware_http.SliceRouterContext, lb load_balance.LoadBalance) *httputil.ReverseProxy {
	//请求协调者
	director := func(req *http.Request) {
		...
		//// 很多情况下都是直接放的 ip:port 没有 schema
		//if !strings.HasPrefix("http://", nextAddr) && !strings.HasPrefix("https://", nextAddr) {
		//	nextAddr = "http://" + nextAddr
		//}
